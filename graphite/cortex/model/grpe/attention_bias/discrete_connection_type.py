...
class DiscreteConnectionTypeEmbeddingAttentionBias(AttentionBiasBase):
    ...
    def compute_supplementary_reps(
        ...
        Parameters
        ----------
        values: `torch.Tensor`, optional (default=None)
            values of `dim=(b, h, n, rep_dim)`, if provided, the traditional value is included in the output as well.
        ...
        if values is not None:
            outputs = outputs + torch.matmul(attention_weights, values)  # b, h, n, rep_dim
